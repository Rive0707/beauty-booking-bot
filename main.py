...
async def api_get_availability(start_date: str, days: int = 7, duration_minutes: int = None, exclude_booking_id: int = None):
    ...
    booked_map = db.get_booked_times_in_range(start.isoformat(), end.isoformat(), exclude_booking_id=exclude_booking_id)
